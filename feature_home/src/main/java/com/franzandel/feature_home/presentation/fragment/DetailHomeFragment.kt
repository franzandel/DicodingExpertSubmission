...
import com.franzandel.feature_home.presentation.adapter.DetailHomeAdapter
...
class DetailHomeFragment : BaseFragmentVM<DetailHomeViewModel, FragmentDetailBinding>() {

    private val viewModel: DetailHomeViewModel by viewModels { viewModelFactory }

    private val detailHomeFragmentArgs: DetailHomeFragmentArgs by navArgs()

    private val gamesResult by lazy {
        detailHomeFragmentArgs.gamesResult
    }
    ...
    override fun getVM(): DetailHomeViewModel = viewModel
