...
class DetailFavoriteRepositoryImplTest {

    private val localData: DetailFavoriteLocalData = mockk(relaxed = true)

    private lateinit var repository: DetailFavoriteRepository

    @Before
    fun setUp() {
        repository = DetailFavoriteRepositoryImpl(localData)
    }
