...
class DetailFavoriteLocalDataImplTest {

    private val dao: DetailFavoriteDao = mockk(relaxed = true)

    private lateinit var localData: DetailFavoriteLocalData
    ...
    @Before
    fun setUp() {
        localData = DetailFavoriteLocalDataImpl(dao, requestMapper, responseMapper)
    }
